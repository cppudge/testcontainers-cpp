...
- **Compose gaps** — service scaling (`--scale`), per-service log streaming, and a socat
  ambassador for UNPUBLISHED ports are still unsupported (`--profile` landed 2026-07-11).
